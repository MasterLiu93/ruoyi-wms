...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.smart.wms";
    private static final String ARTIFACT_ID = "wms";
    private static final String PACKAGE_NAME = "cn.smart.wms";
    private static final String TITLE = "智慧仓储管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.smart.wms";
        String artifactIdNew = "wms";
        String packageNameNew = "cn.smart.wms";
        String titleNew = "智慧仓储管理系统";
        String projectBaseDirNew ="C:\\Users\\Admin\\Desktop\\project\\新建文件夹\\wms-server"; // 一键改名后，“新”项目所在的目录
