package cn.smart.wms.framework.tracer.config;

import cn.smart.wms.framework.common.enums.WebFilterOrderEnum;
import cn.smart.wms.framework.tracer.core.aop.BizTraceAspect;
import cn.smart.wms.framework.tracer.core.filter.TraceFilter;
...
public class WmsTracerAutoConfiguration {
