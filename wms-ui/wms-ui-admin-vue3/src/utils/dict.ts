...
export enum DICT_TYPE {
  ...
  // ========== WMS - 仓储管理系统 ==========
  WMS_CUSTOMER_LEVEL = 'wms_customer_level', // 客户级别
  WMS_SUPPLIER_LEVEL = 'wms_supplier_level', // 供应商级别
  WMS_WAREHOUSE_TYPE = 'wms_warehouse_type', // 仓库类型
  WMS_AREA_TYPE = 'wms_area_type', // 货区类型
  WMS_RACK_TYPE = 'wms_rack_type', // 货架类型
  WMS_LOCATION_TYPE = 'wms_location_type', // 库位类型
  WMS_LOCATION_STATUS = 'wms_location_status', // 库位状态
  WMS_ITEM_TYPE = 'wms_item_type', // 物料类型
  WMS_RECEIPT_TYPE = 'wms_receipt_type', // 入库类型
  WMS_RECEIPT_ORDER_STATUS = 'wms_receipt_order_status', // 入库单状态
  WMS_RECEIPT_STATUS = 'wms_receipt_status', // 入库状态
  WMS_SHIPMENT_TYPE = 'wms_shipment_type', // 出库类型
  WMS_SHIPMENT_ORDER_STATUS = 'wms_shipment_order_status', // 出库单状态
  WMS_SHIPMENT_STATUS = 'wms_shipment_status', // 出库状态
  WMS_MOVE_TYPE = 'wms_move_type', // 移库类型
  WMS_MOVE_ORDER_STATUS = 'wms_move_order_status', // 移库单状态
  WMS_MOVE_STATUS = 'wms_move_status', // 移库状态
  WMS_BATCH_STATUS = 'wms_batch_status', // 批次状态
