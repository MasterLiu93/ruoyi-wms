<template>
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="客户级别（0普通 1重要 2VIP）" prop="customerLevel">
        <el-input
          v-model="queryParams.customerLevel"
          placeholder="请输入客户级别（0普通 1重要 2VIP）"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['wms:customer:create']"
        >
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column label="客户级别（0普通 1重要 2VIP）" align="center" prop="customerLevel" />
      ...
      <el-table-column label="删除标志（0代表存在 2代表删除）" align="center" prop="delFlag" />
