<template>
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['wms:batch-inventory:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['wms:batch-inventory:export']"
        >
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      <el-table-column label="批次库存ID" align="center" prop="id" />
      ...
      <el-table-column label="操作" align="center" min-width="120px">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['wms:batch-inventory:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['wms:batch-inventory:delete']"
          >
            删除
          </el-button>
        </template>
  ...
  <!-- 表单弹窗：添加/修改 -->
  <BatchInventoryForm ref="formRef" @success="getList" />
</template>
...
const list = ref<BatchInventoryVO[]>([]) // 列表的数据
...
const getList = async () => {
  loading.value = true
  try {
    const data = await BatchInventoryApi.getBatchInventoryPage(queryParams)
...
const handleDelete = async (id: number) => {
  try {
    ...
    // 发起删除
    await BatchInventoryApi.deleteBatchInventory(id)
...
const handleExport = async () => {
  try {
    ...
    const data = await BatchInventoryApi.exportBatchInventory(queryParams)
